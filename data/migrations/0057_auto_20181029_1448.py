# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2018-10-29 14:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_job_order_json', models.TextField(blank=True, help_text='JSON containing the portion of the job order specified by system.')),
                ('default_vm_strategy', models.ForeignKey(help_text='todo', null=True, on_delete=django.db.models.deletion.CASCADE, to='data.VMStrategy')),
                ('share_group', models.ForeignKey(help_text='Users who will have job output shared with them', null=True, on_delete=django.db.models.deletion.CASCADE, to='data.ShareGroup')),
            ],
        ),
        migrations.AddField(
