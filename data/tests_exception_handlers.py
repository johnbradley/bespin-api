...
class SwitchingExceptionHandlerTestCase(TestCase):
    ...
    @patch('data.exception_handlers.json_root_object_exception_handler')
    ...
    @patch('data.exception_handlers.exception_handler')
...
class JsonRootObjectExceptionHandlerTestCase(TestCase):
    ...
    @patch('data.exception_handlers.exception_handler')
    @patch('data.exception_handlers.make_json_root_error')
